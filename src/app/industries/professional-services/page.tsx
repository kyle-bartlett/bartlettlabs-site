...
export const metadata: Metadata = {
  title: "Professional Services | Bartlett Labs — AI Automation | Houston, TX",
  description:
...
const solutions = [
  {
    ...
    description:
      "AI-powered intake forms that qualify leads, collect documents, and schedule consultations — automatically. No more phone tag.",
  },
  {
    title: "Billing & time tracking",
    description:
      "Automated time capture, invoice generation, and payment reminders. Turn billable hours into collected revenue faster.",
  },
  {
    title: "Project & case management",
    description:
      "Centralized dashboards with automated status updates, deadline alerts, and client communication workflows.",
  },
];
      ...
      <main className="relative pt-16 pb-16 px-6">
        <div className="container-bl">
          <div className="fade-in-section mb-16 pt-8">
            ...
            <p className="label-mono text-accent-blue mb-3">Professional Services</p>
            ...
            <p className="mt-4 text-lg text-silver max-w-xl">
              Client intake, billing, and project tracking for law firms, accountants, and consultants — delivered in 1 week.
            </p>
          </div>
            ...
            <div className="card p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-text-muted">Professional Services · Houston, TX</p>
                </div>
              </div>
              <p className="text-base leading-relaxed text-silver italic">
                &ldquo;Case studies and testimonials from professional services clients will appear here as we grow our portfolio.&rdquo;
              </p>
            </div>
          </div>
